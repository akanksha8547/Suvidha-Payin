...
export default function PayinReport({ navigationPage, setNavigationPage }) {
    ...
    const columns = [
        ...
        { field: 'txn', headerName: 'TXN', headerAlign: "center",  align: "center", cellClassName: "super-app-theme--cell", width:130},
        { field: 'utr', headerName: 'UTR', headerAlign: "center",  align: "center", cellClassName: "super-app-theme--cell", width:130},
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="card my-4">
                            <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div className="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 className="text-white text-capitalize ps-3">Payin Report Table</h6>
                                </div>
                            </div>
                            <div className="card-body p-3">
